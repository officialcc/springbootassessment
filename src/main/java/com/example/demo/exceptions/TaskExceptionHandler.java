...
public class TaskExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // As TaskExceptionHandler extends ResponseEntityExceptionHandler
    // this class will inherit the built-in methods from ResponseEntityExceptionHandler

    // User has sent data that is not readable, handleHttpMessageNotReadable returns message with a BAD_REQUEST status code
    @Override
    ...
    // When a resource that user is looking for is not found, provide feedback by customising
    // the exception handler to inform the user that the resource looked for is not found
